...
async def seed_database():
    ...
    async with AsyncSessionLocal() as session:
        ...
        # Also add one default client user for demo auth
        demo_client = User(
            email="demo.client@mindgigs.com",
            full_name="Alex Rivera (Client Demo)",
            role="client",
            public_handle="alex_client"
        )
